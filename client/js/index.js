...
let prostudaGripGolro  = document.querySelector(".prostudaGripGolro");
let zheludok  = document.querySelector(".zheludok");
let bolI  = document.querySelector(".bolI");
let genikoloo  = document.querySelector(".genikoloo");
let mazi  = document.querySelector(".mazi");
let all  = document.querySelector(".all");

bolI.addEventListener('click',(e)=>{
    e.preventDefault();
    axios('http://localhost:1337/api/bol-i-vospolenies?populate=*')
    .then(res =>{
        console.log(res.data['data']);
        let datas = res.data['data'];
        shopsItems.innerHTML = ""
...
zheludok.addEventListener('click',(e)=>{
    e.preventDefault();
    axios('http://localhost:1337/api/zheludok-kishechniks?populate=*')
    .then(res =>{
        console.log(res.data['data']);
        let datas = res.data['data'];
        shopsItems.innerHTML = ""
...
genikoloo.addEventListener('click',(e)=>{
    e.preventDefault();
    axios('http://localhost:1337/api/genikologiya-i-urologiyas?populate=*')
    .then(res =>{
        console.log(res.data['data']);
        let datas = res.data['data'];
        shopsItems.innerHTML = ""
...
mazi.addEventListener('click',(e)=>{
    e.preventDefault();
    axios('http://localhost:1337/api/lechebnye-mazis?populate=*')
    .then(res =>{
        console.log(res.data['data']);
        let datas = res.data['data'];
        shopsItems.innerHTML = ""
...
prostudaGripGolro.addEventListener('click',(e)=>{
    e.preventDefault();
    axios('http://localhost:1337/api/prostuda-nasmork-bol-v-gorles?populate=*')
    .then(res =>{
        console.log(res.data['data']);
        let datas = res.data['data'];
        shopsItems.innerHTML = ""
